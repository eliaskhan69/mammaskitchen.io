    ...
    <body data-spy="scroll" data-target="#template-navbar">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">
                        <img id="logo" src="{{asset('fontend/images/Logo_main.png')}}" class="">
                    </a>
                </div>
                            ...
                            <ul id="menu-pricing" class="menu-price">
                                @foreach($items as $item)
                                    <li class="item" id="{{$item->category->slug}}">
                                        ...
                                        <a href="#">
                                            <img src="{{asset('uploads/item/'.$item->image)}}" style="height: 200px;width: 300px;"
                                                 class="img-responsive" alt="Food-Item" >
        ...
        <div class="container-fluid" style="margin: 50px">
            <div class="row">
                <div id="map-canvas">
                    <div class="map">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4341.400645659107!2d90.39984615075501!3d23.79482546867882!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c711d13bbec7%3A0xc47f7c3e8e2263f2!2sAmerican+International+University-Bangladesh!5e0!3m2!1sen!2sbd!4v1462293399657"
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2018 <a href="#">Your Website Link.</a>Developed By<a href="#"> KKeSoft</a> Theme by <a href="{{asset('')}}"  target="_blank"></a>
                            </p>
                        </div>
                    </div>
                </div>
